...
Ned.add({
    ...
    ids: { type: Number, index: true },      // id ломает все нахер!
    new: { type: Number, initial: true, label: "Новая"   },
    ...
    etaz: { type: Number, initial: true, label: "Этаж"   },
    etazost: { type: Number, initial: true, label: "Этажность"   },
    plosh: { type: Number, initial: true, label: "Площадь"   },
    zilaya: { type: Number, initial: true, label: "Жилая"   },
    kuhnya: { type: Number, initial: true, label: "Кухня"   },
    price: { type: Number, initial: true, label: "Цена"   },
    contact: { type: Number, initial: true, label: "Телефон"   },
    date: { type: Date, initial: true, label: "Дата"   },
